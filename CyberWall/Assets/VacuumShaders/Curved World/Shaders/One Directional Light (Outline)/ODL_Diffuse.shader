...
Shader "VacuumShaders/Curved World/Outline/One Directional Light"
{
	Properties     
	{                     
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
		       "CurvedWorldTag"="Outline/One Directional Light/Opaque/Texture" 
		...
		//Base
		UsePass "VacuumShaders/Curved World/One Directional Light/FORWARD"
